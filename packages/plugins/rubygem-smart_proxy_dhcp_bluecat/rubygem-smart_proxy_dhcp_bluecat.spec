...
License: GPLv3
URL: https://github.com/theforeman/smart_proxy_dhcp_bluecat
...
%description
BlueCat DHCP provider plugin for Foreman's smart proxy.
...
mv %{buildroot}%{gem_instdir}/config/dhcp_bluecat.yml.example \
   %{buildroot}%{foreman_proxy_settingsd_dir}/dhcp_bluecat.yml

%files
%dir %{gem_instdir}
%config(noreplace) %attr(0640, root, foreman-proxy) %{foreman_proxy_settingsd_dir}/dhcp_bluecat.yml
...
* Tue May 26 2020 Adam Ruzicka <aruzicka@redhat.com> 0.1.0-5
...
* Wed Dec 18 2019 Eric D. Helms <ericdhelms@gmail.com> - 0.1.0-2
- Bump minimum foreman proxy version

* Thu Oct 17 2019 Matthias Dellweg <dellweg@atix.de> 0.1.0-1
- Add rubygem-smart_proxy_dhcp_bluecat generated by gem2rpm using the smart_proxy_plugin template
